            ...
            <div class="pull-left" style="width:60%;">
                <form action="{{ route('FinanceFreeze') }}" method="get" id="form-search">
                    <div class="select-main">
                        ...
                        <div class="form-select">
                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<button type="submit" class="btn btn-large btn-update">
                                提交
                            </button>
                        </div>
                        ...
                        <div class="form-select">
                            <label class="form-select-title"
                                   style="font-weight:normal;color:red;">注：如果需要取消冻结，针对特定合伙人，将冻结金额设置为0即可。</label>
                        </div>
                        ...
                        <tr>
                            ...
                            <td id="account_type">
                                @foreach ($accounts as $account)
                                    <label for="a{{ $account->id }}"><input type="radio" name="account_type"
                                                                            id="a{{ $account->id }}"
                            ...
                            <td class="text-center">
                                ...
                                <button type="submit" id="addyh" class="btn-groups btn-submit"
                                        onclick="freeze_check(); return false;">确认
                                </button>
                            </td>
                        </tr>
