...
<div class="container-fluid head-table">
    ...
    <div class="container-fluid">
        <div class="pull-left" style="width:84%;">
            <form action="{{ route('BenefitWithdrawsearch') }}" method="get" id="advance_form">
        ...
        <div class="pull-right text-right" style="width:16%">
            <a href="/admin/benefit/export?<?php echo $_SERVER['QUERY_STRING']; ?>" class="btn btn-large btn-add marginTop">导出excel</a>
        </div>
    </div>
    <!-- 内容检索 End -->
    ...
    <div class="paging">
        ...
        @if ($controller_action['action'] == 'withdrawsearch')
