...
<div class="container-fluid head-table">
        ...
        <form method="post" name="applycard_form" id="myForm">
            ...
            <table class="table table-hover">
                ...
                <tr>
                    ...
                    <td>
                        <a class="btn btn-small btn-update" onclick="applycard_show({{ $applycard->id }});return false;">详情</a> 
                        @if (strpos(Request::path(), 'finished') === false)
                        <a onclick="applycard_review({{ $applycard->id }});return false;" class="btn btn-small btn-check">审核</a> 
                        @endif
                    </td>
                </tr>
                @endforeach
    ...
    <div class="paging">
        ...
        {!! $applycards->appends($request->all())->render() !!}　<p class="pull-right" style="padding:6px 12px;">共有{{ $applycards->total() }}条记录</p>
