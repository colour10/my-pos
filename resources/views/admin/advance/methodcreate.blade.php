...
<div class="container marginTop marginTop4">
    ...
    <form action="{{ route('AdvanceMethodstore') }}" method="post" name="method_form">
        ...
        <div class="form-group">
            ...
            <input class="form-control form-control20 form-control-w20" type="text" name="name" />
        </div>

        <div class="form-group">
            <label class="form-title">支付通道账户号：</label>
            <input class="form-control form-control20 form-control-w20" type="text" name="acctno" /> 
            <span></span>
        </div>

        <div class="form-group">
            <label class="form-title">支付通道登录用户名：</label>
            <input class="form-control form-control20 form-control-w20" type="text" name="username" /> <span></span>
        </div>

        <div class="form-group">
            <label class="form-title">支付通道登录密码：</label>
            <input class="form-control form-control20 form-control-w20" type="text" name="password" /> <span></span>
        </div>

        <div class="form-group">
            <label class="form-title">支付通道商户代码：</label>
            <input class="form-control form-control20 form-control-w20" type="text" name="merchant_id" /> <span></span>
        </div>

        <div class="form-group">
            <label class="form-title">业务类型：</label>
            <input class="form-control form-control20" type="text" name="business_code" /> <span></span>
        </div>

        <div class="form-group">
            <label class="form-title">成本费率：</label>
            <input class="form-control form-control20" type="text" name="cost_rate" /> <span>%</span>
        </div>

        <div class="form-group">
            <label class="form-title">单笔最高限额：</label>
            <input class="form-control form-control20" type="text" name="max" /> <span>元</span>
        </div>

        <div class="form-group">
            <label class="form-title">单笔结算费用：</label>
            <input class="form-control form-control20" type="text" name="per_charge" /> <span>元/笔</span>
        </div>
        ...
        <div class="form-group cursor">
            ...
            <input type="radio" name="status" id="inlineRadio2" value="0" checked="checked">
            <label for="inlineRadio2"> 禁用 </label>
        </div>

        <div class="form-group form-submit">
            <button type="submit" id="addyh" class="btn-groups btn-submit" onclick="method_check(); return false;">添加</button>
...
<script type="text/javascript">
    ...
    function method_check() {
        ...
        ajax("{{ route('AdvanceMethodstore') }}", fd, "{{ route('AdvanceMethod') }}");
