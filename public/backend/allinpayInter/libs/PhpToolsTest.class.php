...
class PhpTools
{
	...
	// const certFile = $this->base_url . '/data/allinpay-pds.pem';//通联公钥证书
	// const privateKeyFile = $this->base_url . '/data/20060400000044502.pem';//商户私钥证书
...
//	const  apiUrl = 'http://172.16.1.11:8080/aipg/ProcessServlet';//通联系统对接请求地址（内网）
    ...
    {   
		$this->base_url = dirname(dirname(__FILE__));
		$this->certFile = $this->base_url . '/data-test/allinpay-pds.pem';//通联公钥证书
		$this->privateKeyFile = $this->base_url . '/data-test/20060400000044502.pem';//商户测试私钥
		// $this->privateKeyFile = $this->base_url . '/data/20011000000820104.pem';//商户正式私钥
